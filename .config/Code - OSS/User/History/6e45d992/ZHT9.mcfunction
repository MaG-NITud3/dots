...
execute as @e[type=piglin,predicate=test:piglin_offhand_gold,nbt={IsBaby:false}] if score @s Barter matches 120 run scoreboard players add @e[type=piglin] Times 1
